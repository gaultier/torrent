...
CC='zig cc' CFLAGS="--target=$TARGET -ffunction-sections -fdata-sections -Wno-unused-command-line-argument" LDFLAGS="-static -L./submodules/libuv/$BUILD_DIR" ./build.sh release
